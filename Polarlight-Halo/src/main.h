...
extern std::vector<std::string> gPhysicalDisplayNames;
extern int gNumPhysicalDisplays;
extern std::string physical_display_data_file;
...
extern std::vector<unsigned char> _dummyContentType;
bool
WaitWordbook(const std::string &key,
  std::vector<unsigned char> &value, 
  std::vector<unsigned char> &contentType = _dummyContentType, 
