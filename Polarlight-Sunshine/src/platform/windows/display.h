...
namespace platf::dxgi {
  ...
  public:
    ...
    void
    set_pos(LONG topleft_x, LONG topleft_y, LONG display_width, LONG display_height,
  ...
  public:
    int
    init(int displayId,const ::video::config_t &config, const std::string &display_name);
    capture_e
    ...
    int width_after_rotation;
    int height_after_rotation;
