...
//define ENCRYPT_FLAG as a flag to enable or disable AES Encription
...
#undef _CONVERT_
  ...
  video_t video {
    ...
    {},  // encoder2
    {},  // adapter2_name
    "\\\\.\\DISPLAPLACEHOLDER",  // output2_names
    true, //haveSecondOutput
  ...
  sunshine_t sunshine {
    ...
    {},  // cmd args
    47989,
    platf::appPath().string() + "log\\sunshine.log",  // log file
    {},  // prep commands
  };
  ...
  parse(int argc, char *argv[]) {
    ...
    /*if (!fs::exists(sunshine.config_file)) {
      ...
      archive_log_file(config::sunshine.log_file.c_str());
    } */
    
    delete_unnecessary_log_files (config::sunshine.log_file.c_str());
