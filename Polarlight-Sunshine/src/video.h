...
namespace video {
  ...
  struct hdr_info_raw_t {
    explicit hdr_info_raw_t(bool enabled, int displayIndex):
        enabled { enabled }, metadata {}, displayIndex {displayIndex} {};
    explicit hdr_info_raw_t(bool enabled, const SS_HDR_METADATA &metadata, int displayIndex):
        enabled { enabled }, metadata { metadata }, displayIndex {displayIndex} {};
